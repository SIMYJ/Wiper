...
class ObjectEraserActivity : AppCompatActivity() {
    ...
    var canvas_setting: Int = 0    // 그림 그리기 설정 활성화 or 비활성화
    var penWidth: Int = 0    // 펜두께
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.imgViewObjectEraser.setOnClickListener {
            ...
            //이미지 경로 없는 경우(실행X)
                ...
                progressDialog!!.setMessage("열심히 이미지 처리하는 중...")
        ...
        binding.imgViewCanvasDraw.setOnClickListener {
            ...
            val seekBar: SeekBar = findViewById<SeekBar>(R.id.penWidthSetting)
            seekBar.progress = 0
                ...
                if (bitmap_tmp == null) {
                    ...
                    seekBar.setOnSeekBarChangeListener(object: SeekBar.OnSeekBarChangeListener{
                        override fun onProgressChanged(
                            ...
                            dynamicCanvasView!!.setPenWidth(progress)
                        }

                        override fun onStartTrackingTouch(seekBar: SeekBar?) {
                            dynamicCanvasView!!.setPenWidth(seekBar!!.progress)
                        }
                    ...
                    binding.canvasText.visibility = View.VISIBLE
                    binding.penWidthSetting.visibility = View.VISIBLE

                    // 확인 버튼 클릭
                    binding.completeBtn.setOnClickListener {
                        binding.completeBtn.visibility = View.GONE
                        binding.canvasText.visibility = View.GONE
                        binding.penWidthSetting.visibility = View.GONE
                        canvas_setting = 0
                    }
                }
